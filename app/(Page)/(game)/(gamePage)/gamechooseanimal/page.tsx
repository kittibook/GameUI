...
export default function Game_AnimalMatch() {
  ...
  const [currentAnimal, setCurrentAnimal] = useState<currentAnimal | null>(
    null
  );
                ...
                <>
                  ...
                  <div className="flex flex-wrap justify-center items-center gap-6 mt-10 max-w-4xl">
                    ...
                    <button
                      ...
                      className="bg-blue-50 px-4 py-2 rounded-xl shadow text-center w-fit mx-auto mt-3 hover:bg-blue-100 transition"
                    >
